    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (command == 1) {
                ...
                System.out.println("Всего потрачено: " + expensesManager.getExpensesSum()); // дописать метод
            } else if (command == 8) {
                System.out.println("Какую категорию вы хотите удалить?");
                String name = scanner.next(); // Читаем название категории, которую нужно удалить.
                expensesManager.removeCategory(name);  // вызываем метод удаления категории
            } else if (command == 9) {
